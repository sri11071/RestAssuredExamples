...
public class ExcelHashmapIntegrationExample {

	 

	@Test(dataProvider = "booksInformationCollect")
	public void addBookAPI(String name, String isbn, String aisle, String author) {
		...
		String addbookResponse = given().log().all().header("Content_Type", "application/json").body(map).when()
	...
	@DataProvider
	public Object[][] booksInformationCollect() throws Exception {
		int rowCount = 0;
		int colCount = 0;
		...
		XSSFSheet mySheet = workbook.getSheet("RestAssured");
